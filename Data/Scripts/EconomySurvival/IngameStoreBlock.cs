...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_StoreBlock), 
    "EconomySurvivalStoreBlock",
    "NPC_Shop_Market_Merchant_Standing",
    "NPC_Shop_Market_Merchant_Desk",
    "NPC_Shop_Market_Store_Standing_Small"
    )]
    public class IngameStoreBlockGameLogic : MyGameLogicComponent
    {
        ...
        private void CreateConfig()
        {
            ...
            config.SetSectionComment(ConfigSettings, "Do not activate too many objects the store is hardcoded to have 30 slots maximum");
